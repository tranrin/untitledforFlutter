...
import 'package:untitled3/screen/components/body.dart';
import 'package:untitled3/screen/components/custom_app_bar.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void asyncMethod(BuildContext context) async {
    var check=await checktam.fetchData(1, context);
    setState(() {
      tam1=check;
    });
  }
    ...
    try{
      ...
      if(response.statusCode == 200){
       ...
       var value=  detailproductresponse.fromJson(map);
        //var globalvar=value;
        globalvar=value;
      //  print(value.product.description);
